...
///
class JavaScriptEngineBindings {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  JavaScriptEngineBindings(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  JavaScriptEngineBindings.fromLookup(
...
typedef duk_int_t = duk_int_fast32_t;
typedef duk_int_fast32_t = int_fast32_t;
...
typedef duk_uint_t = duk_uint_fast32_t;
typedef duk_uint_fast32_t = uint_fast32_t;
...
const int DUK_INVALID_INDEX = -9223372036854775808;
